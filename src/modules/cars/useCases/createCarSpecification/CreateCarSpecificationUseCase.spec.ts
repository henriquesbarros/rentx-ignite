...
let createCarSpecficationUseCase: CreateCarSpecficationUseCase;
...
describe("Create car specification", () => {
    beforeEach(() => {
        ...
        createCarSpecficationUseCase = new CreateCarSpecficationUseCase(
    ...
    it("should not be able to add a new specification to a non-exitent car", async () => {
        ...
        await expect(
            createCarSpecficationUseCase.execute({
                car_id,
                specifications_id,
            })

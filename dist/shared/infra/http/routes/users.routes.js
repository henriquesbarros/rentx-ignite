...
usersRoutes.patch("/avatar", _ensureAuthenticated.ensuredAuthenticated, uploadAvatar.single("avatar"), updateUserAvatarController.handle);
usersRoutes.get("/profile", _ensureAuthenticated.ensuredAuthenticated, profileUserController.handle);
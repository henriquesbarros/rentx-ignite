...
usersRoutes.patch("/avatar", ensureAuthenticated_1.ensuredAuthenticated, uploadAvatar.single("avatar"), updateUserAvatarController.handle);
usersRoutes.get("/profile", ensureAuthenticated_1.ensuredAuthenticated, profileUserController.handle);

...
categoriesRoutes.post("/", ensureAuthenticated_1.ensuredAuthenticated, ensureAdmin_1.ensureAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", ensureAuthenticated_1.ensuredAuthenticated, ensureAdmin_1.ensureAdmin, upload.single("file"), importCategoryController.handle);

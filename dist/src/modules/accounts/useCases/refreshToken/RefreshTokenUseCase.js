    ...
    RefreshTokenUseCase.prototype.execute = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = jsonwebtoken_1.verify(token, auth_1.default.secrect_refresh_token), email = _a.email, sub = _a.sub;
                        user_id = sub;
                    ...
                    case 2:
                        _b.sent();
                        refresh_token = jsonwebtoken_1.sign({ email: email }, auth_1.default.secrect_refresh_token, {
                            subject: sub,

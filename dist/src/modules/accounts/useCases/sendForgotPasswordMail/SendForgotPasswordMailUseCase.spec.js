...
describe("Send forgot mail", function () {
    ...
    it("should be able to send a forgot password mail to user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("po@vu.mu")];
                case 2:
                    _a.sent();
    ...
    it("should not be able to send an email if user does not exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordMailUseCase.execute("faejate@vowhogje.mn")).rejects.toEqual(new AppError_1.AppError("User does not exists!"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("should be able to create an users token", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUseCase.execute("dapogkug@suwnanla.ie")];
                case 2:
                    _a.sent();

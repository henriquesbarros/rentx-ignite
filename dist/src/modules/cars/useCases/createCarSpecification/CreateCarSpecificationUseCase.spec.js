...
var createCarSpecficationUseCase;
...
describe("Create car specification", function () {
    beforeEach(function () {
        ...
        createCarSpecficationUseCase = new CreateCarSpecificationUseCase_1.CreateCarSpecficationUseCase(carsRepositoryInMemory, specificationsRepositoryInMemory);
    });
    it("should not be able to add a new specification to a non-exitent car", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, expect(createCarSpecficationUseCase.execute({
                            car_id: car_id,
